...
1. Get data `wget https://github.com/snakemake/snakemake-tutorial-data/archive/v5.24.1.tar.gz`
1. Create a environment file [`img/environment.yml`](img/environment.yml)
